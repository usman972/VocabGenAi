...
class TimePicker() : DialogFragment() {
    ...
    private var title: String? = null
     ...
     val ONE_SECOND: Long = 1000L // 1000 milliseconds
    ...
    fun setInitialTimeMillis (timeMillis: Long) {
        initialHour = (timeMillis / (ONE_MINUTE * 60)).toInt()
        initialMinute = ((timeMillis % (ONE_MINUTE * 60)) / ONE_MINUTE).toInt()
        val rest = (timeMillis % (ONE_MINUTE * 60)) % ONE_MINUTE
        initialSeconds = (rest / ONE_SECOND).toInt()
    }
